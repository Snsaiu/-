...
namespace programmingQuickSetup
{
    class GetRAMInfo
    {
        ...
        #endregion
        private string getavilram;

        public string GetAvilRam
        {
            get { return getavilram; }
            set { getavilram = value; }
        }
        ...
        public GetRAMInfo()
        {
           this.GetAvilRam = FormatSize(GetAvailPhys());
            this.GetTotalRam = FormatSize(GetTotalPhys());
        }
